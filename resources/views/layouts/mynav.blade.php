<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="px-2 py-2 ">
                    ...
                    @canany(['create-item', 'edit-item', 'delete-item','show-item'])
                    <a class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out"
                        href="{{ route('admin.items.index') }}">Manage items</a>
                    @endcanany
                </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button {{-- todo mettre en place active --}}
            ...
            <!-- Responsive Navigation Menu  if not login -->
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
    ...
    <div x-show="open" class="lg:hidden ">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            @endcanany
            <div class="px-2 py-2 ">
                @canany(['create-item', 'edit-item', 'delete-item'])
